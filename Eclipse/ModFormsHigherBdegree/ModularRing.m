...
d::usage="d[algebra] are the indices of the basis of Jacobi forms (actually of the dual for Cn and Bn)"
w::usage="w[algebra] are the weights of the basis of Jacobi forms (actually for the dual for Cn and Bn)"
...
d[Algebra[A][k_]]:=Array[1&,k+1]
w[Algebra[A][k_]]:=Join[{0},Range[2,k+1]]

d[Algebra[C][k_]]:=Array[1&,k+1]
w[Algebra[C][k_]]:=Join[{0},Range[2,2k,2]]

d[Algebra[B][k_]]:=Join[{1,1,1},Array[2&,k-2]]
w[Algebra[B][k_]]:=Join[{0},Range[2,2k,2]]

d[Algebra[D][k_]]:=Join[{1,1,1,1},Array[2&,k-3]]
...
\[Phi][2, D8] := \[Phi][2, D8] = Expand /@ (3 Hdiff[-4, 1, \[Phi][4, D8]])
